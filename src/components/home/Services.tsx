                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`${service.spanClass} group relative rounded-[32px] overflow-hidden bg-white/5 dark:bg-black/20 p-[1px]`}
                            >
                                {/* Interactive Stroke/Border Glow */}
                                <div className={`absolute inset-0 bg-gradient-to-br from-white/20 to-transparent dark:from-white/10 opacity-100 transition-colors duration-500 ${service.borderGlow}`} />

                                {/* Card Content Surface - Enhanced Frosted Glassmorphism */}
                                <div className="relative h-full flex flex-col bg-white/60 dark:bg-[#00050d]/60 backdrop-blur-2xl rounded-[31px] p-8 md:p-10 transition-colors duration-500 hover:bg-white/70 dark:hover:bg-[#00050d]/80 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
